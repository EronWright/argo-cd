...
func setNewRevisionManifestsOnManagedCluster(
	clusterName string,
	newRevision string,
	revision string,
	appSrc *v1alpha1.ApplicationSource,
	oldSrcRefs v1alpha1.RefTargetRevisionMapping,
	newSrcRefs v1alpha1.RefTargetRevisionMapping,
	clusterInfo cache.ClusterRuntimeInfo,
	appNamespace string,
	trackingMethod string,
	appLabelKey string,
	appName string,
	oldRefSourceCommitSHAs cache.ResolvedRevisions,
	newRefSourceCommitSHAs cache.ResolvedRevisions,
	...
	return repoCache.SetNewRevisionManifests(newRevision, revision, appSrc, oldSrcRefs, newSrcRefs, clusterInfo, appNamespace, trackingMethod, appLabelKey, appName, oldRefSourceCommitSHAs, newRefSourceCommitSHAs, installationID)
}
...
func getRedisPasswordFromACLSecretFile(clusterName string) (string, error) {
	...
	if prevAclFileStat == nil || stats.ModTime() != (*prevAclFileStat).ModTime() || stats.Size() != (*prevAclFileStat).Size() {
